...
app_ui <- function(request) {
  ...
  sidebar <- shinydashboard::dashboardSidebar(
    shinydashboard::sidebarMenu(id = "tabs",
                                ...
                                shinydashboard::menuItem("Rule Extraction FPM",
                                                         tabName = "fpm",
                                                         icon = shiny::icon("sitemap")),
                                shinydashboard::menuItem("Rule Extraction SBI",
                                                         tabName = "sbi",
                                                         icon = shiny::icon("sitemap")),
  ...
  body <- shinydashboard::dashboardBody(
    shinydashboard::tabItems(
      ...
      shinydashboard::tabItem(tabName = "fpm",
                              mod_rule_fpm_ui("fpm")),
      shinydashboard::tabItem(tabName = "sbi",
                              mod_rule_sbi_ui("sbi")),
